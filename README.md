...
- **Dev Server URL**: `http://127.0.0.1:5212`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/4115d305-e3ed-4ef5-8ab3-22ce622928fb/preview`
- **Port**: `5212`
...
4. The dev server is accessible at `http://127.0.0.1:5212`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/4115d305-e3ed-4ef5-8ab3-22ce622928fb/preview`
